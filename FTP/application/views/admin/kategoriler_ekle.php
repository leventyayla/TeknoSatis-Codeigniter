    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card">
                        ...
                        <div class="body">
                            <form class="form-horizontal" action="<?=base_url()?>admin/categories/add_commit" method="post">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            ...
                                            <?php foreach ($veriler as $data) { ?>
                                                <option value="<?=$data->Id?>"><?=$data->adi?></option>
                                            <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="anahtar_kelime" class="form-control" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                                        <input type="submit" class="btn btn-primary m-t-15 waves-effect" value="Ekle">
                                    </div>
                                </div>
                            </form>
                        </div>
