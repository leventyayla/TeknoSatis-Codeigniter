    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card">
                        ...
                        <div class="body">
                            <form class="form-horizontal" action="<?=base_url()?>admin/slider/add_commit" method="post">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <textarea id="baslik" name="baslik" ></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <textarea id="buyuk_baslik" name="buyuk_baslik" ></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="buton_text" class="form-control" >
                                            </div>
                                        </div>
                                    </div>
                                </div>
